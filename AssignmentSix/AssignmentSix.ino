...
unsigned long zeroTime; //gebruikt om timer vanaf interactie te laten lopen
float seconds = 0;
int minutes = 0;
int hours = 0;
...
// zodra knop 1 ingedruk gehouden word gaat een kleine timer lopen
    ...
    timeElapsed = millis() - zeroTime;

    unsigned long totalSeconds = timeElapsed / 1000;
    hours = totalSeconds / 3600;
    minutes = (totalSeconds % 3600) / 60;
    seconds = (timeElapsed % 60000) / 1000.0;
